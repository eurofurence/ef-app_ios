...
class WhenSyncSucceeds_SyncAPIShould: XCTestCase {
    ...
    private func makeExpectedSyncResponseFromTestFile() -> APISyncResponse {
        let knowledgeGroups = APISyncResponse.Delta<APIKnowledgeGroup>(changed: [APIKnowledgeGroup(identifier: "ec031cbf-d8d0-825d-4c36-b782ed8d19d8",
                                                                                                   order: 0,
        ...
        let knowledgeEntries = APISyncResponse.Delta<APIKnowledgeEntry>(changed: [APIKnowledgeEntry(identifier: "28b153de-4797-99b6-ab80-f1f851dd2bde",
        ...
        let rooms = APISyncResponse.Delta<APIRoom>(changed: [APIRoom(roomIdentifier: "dfa62eae-f881-4aab-a592-acf8fab14ae9",
        ...
        let events = APISyncResponse.Delta<APIEvent>(changed: [APIEvent(identifier: "22b70985-ccd9-44f7-920b-ad9224558b9f",
        ...
        let tracks = APISyncResponse.Delta<APITrack>(changed: [APITrack(trackIdentifier: "f92a4fc0-303f-4c13-9194-44121d80bd20",
                                                                        name: "Stage")],
        ...
        let changedConferenceDayDate = DateComponents(calendar: .current,
                                                      ...
                                                      month: 8,
                                                      day: 15).date!
        let conferenceDays = APISyncResponse.Delta<APIConferenceDay>(changed: [APIConferenceDay(identifier: "5f2e5aa4-a172-4f8b-8441-1e676ea3be9f",
                                                                                                date: changedConferenceDayDate)],
                                                                     deleted: ["db8e0455-8c49-4bc5-b472-e0033fe06b99"],
                                                                     removeAllBeforeInsert: true)

        let dealers = APISyncResponse.Delta<APIDealer>(changed: [APIDealer(identifier: "f112a4db-7856-4087-806d-b2704717dba3",
        ...
        let maps = APISyncResponse.Delta<APIMap>(changed: [APIMap(identifier: "d6f1c9b4-6d03-41cc-ae5d-ee278e5121f0",
        ...
        let images = APISyncResponse.Delta<APIImage>(changed: [APIImage(identifier: "8ae7d323-b56d-4155-8a88-6b418bcfd057",
