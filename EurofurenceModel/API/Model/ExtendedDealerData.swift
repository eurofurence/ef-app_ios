...
public struct ExtendedDealerData {
    ...
    public init(artistImagePNGData: Data?, dealersDenMapLocationGraphicPNGData: Data?, preferredName: String, alternateName: String?, categories: [String], dealerShortDescription: String, isAttendingOnThursday: Bool, isAttendingOnFriday: Bool, isAttendingOnSaturday: Bool, isAfterDark: Bool, websiteName: String?, twitterUsername: String?, telegramUsername: String?, aboutTheArtist: String?, aboutTheArt: String?, artPreviewImagePNGData: Data?, artPreviewCaption: String?) {
